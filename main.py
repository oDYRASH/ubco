...
def home():
    ...
    with open('coach.json', 'r') as file:
        data = json.load(file)

    # Access the value associated with the key 'coach'
    coach = data['coach']
    return render_template('home.html', profiles=coach)
...
def profile(profile_id):
    ...
    # Access the value associated with the key 'coach'
    coaches = data['coach']
    profile  = next((coach for coach in coaches if coach['id'] == profile_id), None)
